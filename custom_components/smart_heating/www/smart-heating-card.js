...
language: 'LANGUAGE', locale: 'en-GB', weather_sunny: 'Sunny', weather_clear: 'Clear', weather_night: 'Clear', weather_partlycloudy: 'Partly cloudy', weather_cloudy: 'Cloudy', weather_overcast: 'Overcast', weather_rainy: 'Rain', weather_pouring: 'Heavy rain', weather_snowy: 'Snow', weather_sleet: 'Sleet', weather_fog: 'Fog', weather_hail: 'Hail', weather_thunder: 'Thunderstorm', weather_windy: 'Windy', weather_dry: 'No rain', hysteresis: 'HYSTERESIS', labels: 'TEXTS & LABELS', hysteresis_on: 'Turn-on hysteresis (delta)', hysteresis_off: 'Turn-off hysteresis (delta)', hyst_on_desc: 'Drop below target temperature before firing boiler', hyst_off_desc: 'Rise above target temperature before stopping boiler', temp_step: 'Target temperature step', temp_step_desc: 'Step used by the +/− buttons under the climate dial', labels_hint: 'Enter custom text or leave empty for default. The switch next to each field shows or hides that label.', reset_labels: 'Reset all labels', lbl_title: 'Card title', lbl_subtitle: 'Subtitle', lbl_outdoor: 'Outdoor temperature', lbl_wind: 'Wind outside', lbl_rain: 'Precipitation', lbl_humidity: 'Room humidity', lbl_scheme: 'Connection scheme', lbl_contact1: 'Contact 1', lbl_contact2: 'Contact 2', lbl_power: 'Power button', lbl_program: 'Program button', lbl_boiler: 'Status «Boiler running»', lbl_waiting: 'Status «Boiler» (standby)', lbl_history: 'History button', lbl_settings: 'Settings button',,,,,,,,},
};
