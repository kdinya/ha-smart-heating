...
.scheme-card{position:relative;box-sizing:border-box;width:100%;min-height:clamp(68px,8.4cqw,116px);cursor:pointer;user-select:none;padding:clamp(7px,.9cqw,13px) clamp(8px,1cqw,12px);border-radius:clamp(14px,1.8cqw,22px);text-align:center;background:linear-gradient(150deg,#22313b 0%,#111a21 48%,#080e12 100%);border:1px solid rgba(255,255,255,0.12);border-top:1px solid rgba(255,255,255,0.25);box-shadow:0 6px 18px rgba(0,0,0,0.45),inset 0 1px 0 rgba(255,255,255,0.12),inset 0 0 16px rgba(0,0,0,0.6);transition:all .24s cubic-bezier(0.2,0.8,0.2,1);display:flex;flex-direction:column;align-items:center;justify-content:space-between}
.scheme-card:hover{border-color:rgba(255,255,255,0.26);border-top-color:rgba(255,255,255,0.4);transform:translateY(-2px);box-shadow:0 8px 22px rgba(0,0,0,0.55),inset 0 1px 0 rgba(255,255,255,0.2)}
.scheme-card:active{transform:translateY(0)}
.scheme-card.active{background:linear-gradient(150deg,rgba(48,34,18,0.92) 0%,rgba(24,17,10,0.98) 100%);border:1.5px solid rgba(255,148,24,0.85);border-top:1.5px solid rgba(255,188,80,0.95);box-shadow:0 0 20px rgba(255,148,24,0.35),0 8px 24px rgba(0,0,0,0.6),inset 0 1px 1px rgba(255,220,130,0.35),inset 0 0 18px rgba(255,120,0,0.15)}
.scheme-header{display:flex;width:100%;align-items:center;justify-content:space-between;margin-bottom:2px}
.scheme-badge{display:inline-flex;align-items:center;gap:3px;padding:2px clamp(5px,.7cqw,8px);border-radius:999px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);color:#9db0c0;font-size:clamp(8px,.9cqw,11px);font-weight:700;line-height:1}
.scheme-card.active .scheme-badge{background:linear-gradient(135deg,rgba(255,158,44,0.35) 0%,rgba(255,107,0,0.2) 100%);border-color:rgba(255,160,51,0.6);color:#ffbe6b}
.scheme-badge .scheme-sub{font-size:clamp(6px,.7cqw,8.5px);opacity:0.85;letter-spacing:0.5px}
.scheme-led{width:clamp(7px,.8cqw,10px);height:clamp(7px,.8cqw,10px);border-radius:50%;background:#2e3a44;border:1px solid #1a2228;box-shadow:inset 0 1px 2px #000;transition:all .2s ease}
.scheme-card.active .scheme-led{background:#ff9418;box-shadow:0 0 8px #ff9418,0 0 2px #fff}
.scheme-icon{height:clamp(22px,2.8cqw,36px);color:#9eb2c2;display:flex;align-items:center;justify-content:center;margin:3px 0}
.scheme-icon svg{width:clamp(22px,2.7cqw,34px);height:clamp(22px,2.7cqw,34px);filter:drop-shadow(0 2px 4px rgba(0,0,0,0.5));transition:all .22s ease}
.scheme-card.active .scheme-icon{color:var(--orange)}
.scheme-card.active .scheme-icon svg{filter:drop-shadow(0 0 8px rgba(255,148,24,0.65))}
