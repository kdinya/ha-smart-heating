...
3. використовує стандартну адресу `/local/smart-heating-card.js?v=1.0.0&build=ref3d-all-reviews`.
...
```text
/local/smart-heating-card.js?v=1.0.0&build=ref3d-all-reviews
```
