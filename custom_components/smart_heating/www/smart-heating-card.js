...
<button class="sh-reset-btn" data-reset-labels type="button">${tr('reset_labels')}</button>
    ...
    const updateLabelVis=(key,visible)=>{
      ...
      else if(key==='contact1'){const el=root.querySelector('[data-scheme-toggle="1"] span');if(el)el.style.visibility=visVal;}
      else if(key==='contact2'){const el=root.querySelector('[data-scheme-toggle="2"] span');if(el)el.style.visibility=visVal;}
