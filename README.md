...
3. використовує стандартну адресу `/hacsfiles/ha-smart-heating/smart-heating-card.js?v=1.0.2&build=reference-dashboard-v102-canvasfix1`.
...
```text
/hacsfiles/ha-smart-heating/smart-heating-card.js?v=1.0.2&build=reference-dashboard-v102-canvasfix1
```
...
> Для YAML-режиму Lovelace Home Assistant не має writable resource store для інтеграцій. У такому випадку вручну видаліть старий запис `/local/smart-heating-card.js` з `resources:` у YAML-дашборді та додайте `/hacsfiles/ha-smart-heating/smart-heating-card.js`.
