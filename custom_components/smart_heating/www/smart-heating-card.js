...
class SmartHeatingCard extends HTMLElement {
  ...
  render(){
    ...
    this.shadowRoot.innerHTML=`<style>
      ...
      .scheme-title.element-scheme{transform:translate(calc(var(--scheme-x,0) * 1cqw),calc(var(--scheme-y,0) * 1cqh)) scale(var(--scheme-s,1))}.scheme{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:clamp(8px,1.2cqw,16px);align-items:stretch}
.scheme-card{position:relative;box-sizing:border-box;width:100%;min-height:clamp(68px,8.4cqw,116px);cursor:pointer;user-select:none;padding:clamp(6px,.8cqw,12px) clamp(6px,.8cqw,10px);border-radius:12px;text-align:center;background:linear-gradient(155deg,rgba(30,40,48,0.85) 0%,rgba(13,19,24,0.95) 100%);border:1px solid rgba(255,255,255,0.08);border-top:1px solid rgba(255,255,255,0.18);box-shadow:0 4px 14px rgba(0,0,0,0.35),inset 0 1px 0 rgba(255,255,255,0.08);backdrop-filter:blur(10px);transition:all .22s cubic-bezier(0.16,1,0.3,1);display:flex;flex-direction:column;align-items:center;justify-content:space-between}
.scheme-card:hover{border-color:rgba(255,255,255,0.22);border-top-color:rgba(255,255,255,0.35);transform:translateY(-1.5px);box-shadow:0 6px 18px rgba(0,0,0,0.45),inset 0 1px 0 rgba(255,255,255,0.15)}
.scheme-card:active{transform:translateY(0)}
.scheme-card.active{background:linear-gradient(155deg,rgba(46,32,18,0.85) 0%,rgba(20,15,10,0.96) 100%);border:1px solid rgba(255,138,0,0.7);border-top:1px solid rgba(255,170,51,0.95);box-shadow:0 0 18px rgba(255,138,0,0.22),inset 0 1px 1px rgba(255,255,255,0.25),inset 0 0 14px rgba(255,138,0,0.12)}
.scheme-header{display:flex;width:100%;align-items:center;justify-content:space-between;margin-bottom:2px}
.scheme-number{display:inline-flex;width:clamp(15px,1.8cqw,24px);height:clamp(15px,1.8cqw,24px);align-items:center;justify-content:center;border-radius:6px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.12);color:#93a5b4;font-size:clamp(8px,1cqw,13px);font-weight:700;transition:all .2s ease}
.scheme-card.active .scheme-number{background:linear-gradient(135deg,#ff9e2c 0%,#ff6b00 100%);border-color:#ffa033;color:#0b1116;font-weight:800;box-shadow:0 0 8px rgba(255,138,0,0.45)}
.scheme-led{width:clamp(6px,.7cqw,9px);height:clamp(6px,.7cqw,9px);border-radius:50%;background:#384652;transition:all .2s ease}
.scheme-card.active .scheme-led{background:#ff8a00;box-shadow:0 0 7px #ff8a00,0 0 2px #fff}
.scheme-icon{height:clamp(18px,2.4cqw,32px);color:#9bb0bf;font-size:27px;line-height:1;display:flex;align-items:center;justify-content:center;margin:2px 0}
.scheme-icon svg{width:clamp(18px,2.3cqw,30px);height:clamp(18px,2.3cqw,30px);fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 2px 3px rgba(0,0,0,0.4));transition:all .2s ease}
.scheme-card.active .scheme-icon svg{fill:currentColor;stroke:currentColor;stroke-width:1.3;filter:drop-shadow(0 0 7px rgba(255,138,0,0.55))}
.scheme-card.active .scheme-icon{color:var(--orange)}
.scheme-card span{display:block;color:#cbd6e2;font-size:clamp(7px,.9cqw,12px);font-weight:600;letter-spacing:0.04em;line-height:1.2;text-transform:uppercase}
.scheme-card.active span{color:#f5f8fb;text-shadow:0 1px 2px rgba(0,0,0,0.6)}
